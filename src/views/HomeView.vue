  ...
  <main>
    ...
    <section class="highlights relative pt-40 pb-52 overflow-x-clip">
      ...
      <div ref="highlights_swiper"
        ...
        <div class="swiper__controls sticky bottom-8 my-8 text-center h-14 z-10">
          <div class="inline-flex h-full">
            ...
            <div
              class="swiper__pagination h-full rounded-[100vmax] bg-[rgba(232,232,237,0.7)] backdrop-blur-lg flex items-center px-4">
            </div>
          </div>
        </div>
      </div>
