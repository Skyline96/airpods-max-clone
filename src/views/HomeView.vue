  ...
  <main>
    ...
    <section class="battery_details overflow-x-clip">
      <div class="section_header">
        <div class="w-[87.5%] max-w-[1680px] mx-auto text-center">
        ...
        <div ref="battery_details_swiper"
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide max-w-min min-w-[373px]">
              <div class="w-[372px] h-[580px] overflow-hidden rounded-[20px]">
                <img src="/images/battery-magical/battery_detection_large.jpg" alt=""
                  class="w-full h-full object-cover">
              </div>
              <div class="mt-6 ps-2 pe-12">
                <p class="text-[17px] font-semibold leading-tight tracking-tight text-[#86868b] text-balance"><span
                    class="text-[#1d1d1f]">Automatic Switching and on-head detection.</span> If you’re playing music on
            ...
            <div class="swiper-slide max-w-min min-w-[373px]">
              ...
              <div class="mt-6 ps-2 pe-12">
                <p class="text-[17px] font-semibold leading-tight tracking-tight text-[#86868b] text-balance"><span
                    class="text-[#1d1d1f]">Audio Sharing.</span> With just a
            ...
            <div class="swiper-slide max-w-min min-w-[373px]">
              <div
                class="relative bg-[conic-gradient(from_45deg,#bb64ff,#ff2288,#ff8b00_28%,#f2416b,#e750de_60%,#0096ff,#bb64ff)] flex items-center w-[372px] h-[580px] overflow-hidden rounded-[20px] text-[#1d1d1f] px-5 before:content-[''] before:absolute before:block before:inset-[38px] before:bg-white before:shadow-[0_0_32px_40px_#fff] before:rounded-[9px]">
                <h3 class="text-5xl font-semibold text-center leading-[1.08] z-10">
                  <span
              ...
              <div class="mt-6 ps-2 pe-12">
                <p class="text-[17px] font-semibold leading-tight tracking-tight text-[#86868b] text-balance"><span
                    class="text-[#1d1d1f]">Always-on Siri.</span> With
            ...
            <div class="swiper-slide max-w-min min-w-[373px]">
              ...
              <div class="mt-6 ps-2 pe-12">
                <p class="text-[17px] font-semibold leading-tight tracking-tight text-[#86868b] text-balance"><span
                    class="text-[#1d1d1f]">USB‑C charging.</span> The new USB‑C connector lets you charge your AirPods
                  Max with the same cable that charges your iPhone, iPad, Mac, or other Apple devices.
                </p>
              </div>
            </div>
            <div class="swiper-slide max-w-min min-w-[373px]">
              <div class="relative w-[372px] h-[580px] overflow-hidden rounded-[20px]">
              ...
              <div class="mt-6 ps-2 pe-12">
                <p class="text-[17px] font-semibold leading-tight tracking-tight text-[#86868b] text-balance"><span
                    class="text-[#1d1d1f]">Battery.</span> Up to 20 hours of listening, movie watching, or talk time —
          ...
          <div class="battery_details_swiper__navigation flex justify-end gap-4 pt-12 pb-20">
            <div class="w-9 h-9">
              <button
                class="prev w-full h-full rounded-[100vmax] bg-[rgba(210,210,215,0.64)] text-black/50 disabled:opacity-50">
                <svg class="icon-control icon-control-chevronleft w-full h-full fill-current"
